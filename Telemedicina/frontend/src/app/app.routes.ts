...
import {DoctorApprovalsComponent} from './view/admin/pages/doctor-approvals/doctor-approvals.component';
...
export const routes: Routes = [
  ...
  { path: 'doctor-approvals', component: DoctorApprovalsComponent }
];
